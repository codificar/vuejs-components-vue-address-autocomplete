...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_VueAddressAutocomplete_vue__ = __webpack_require__(11);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    setNumber: function setNumber() {
      var newAddressWithNumber = _extends({}, this.selectedAddress);
    ...
    setPropsAdress: function setPropsAdress(address) {
    ...
    setAdressAndSelectFirst: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(address) {
        var placesResponse, geocodeResponse;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(this.autocomplete_url, {
                  params: _extends({}, this.api_params, { place: this.search_string })
                });

              case 3:
                placesResponse = _context.sent;
                _context.next = 6;
                return this.callGeocodeApi(placesResponse.data.data[0].address);
      ...
      function setAdressAndSelectFirst(_x) {
    ...
    callAutocompleteApi: function () {
      ...
      function callAutocompleteApi() {
        return _ref2.apply(this, arguments);
      }

      return callAutocompleteApi;
    }(),
    extract_domain_with_protocol: function extract_domain_with_protocol(url) {
      var _ref4 = new URL(url),
    ...
    callPlaceId: function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee3(place_id) {
        var url, _ref6, response;
    ...
    callGeocodeApi: function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee4(address) {
        var _ref8, response;
    ...
    handleSelectAddress: function () {
      var _ref9 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee5(data) {
      ...
      function handleSelectAddress(_x4) {
